...
const backBtn = "px-6 py-3 rounded-sm font-display text-sm border border-brand-line";
...
<button onClick={function () { setStep("sessions"); }} className="ml-auto px-6 py-3 rounded-sm font-display text-sm" style={primaryBtn}>Next</button>
</div>
</div>
</main>
);
...
<button onClick={function () { setStep("days"); }} className="ml-auto px-6 py-3 rounded-sm font-display text-sm" style={primaryBtn}>Next</button>
</div>
</div>
</main>
);
...
className="ml-auto px-6 py-3 rounded-sm font-display text-sm"
...
className="w-full px-6 py-4 rounded-sm font-display text-sm"
