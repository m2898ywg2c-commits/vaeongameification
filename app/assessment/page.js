      ...
      <main className="min-h-screen flex flex-col items-center justify-center bg-brand-bg text-brand-text px-6 py-12">
        <div className="w-full max-w-md">
          ...
          {onChrono ? (
            ...
            <div>
              <h1 className="font-display text-xl font-normal mb-8 min-h-16">
      ...
      <main className="min-h-screen flex flex-col items-center justify-center bg-brand-bg text-brand-text px-6 py-12">
        <div className="w-full max-w-md text-center">
          ...
          <div className="rounded-md border border-brand-line bg-brand-surface p-5 text-left mb-8">
            ...
            <p className="text-sm">
              At your best <span className="font-display">{CHRONOTYPE_LABEL[chronoValue]}</span>. {CHRONOTYPE_TIP[chronoValue]}
            </p>
          </div>

          <div className="flex gap-3 justify-center">
            <a href="/dashboard" className="px-6 py-2.5 rounded-sm font-display text-sm" style={{ background: GRAD, color: "#000000" }}>
              Go to dashboard
            </a>
            <button
              onClick={() => {
              ...
              className="px-6 py-2.5 rounded-sm font-display text-sm border border-brand-line"
            >
              Retake
            </button>
          </div>
      ...
      <div className="max-w-3xl mx-auto">
          ...
          {Object.keys(TYPES).map((id) => {
            ...
            return (
              <div key={id} className="rounded-md border border-brand-line bg-brand-surface p-4 flex flex-col items-center text-center">
                <TypeCharacter typeId={id} size={84} />
        ...
        <div className="text-center">
          <button
            ...
            className="px-8 py-3 rounded-sm font-display text-sm"
