...
export function resolveScheme(choice, deviceScheme) {
  ...
  // "system", or nothing stored yet. Dark is the fallback when the device has not told us,
  // because it is what the app has always been and what the twelve existing users expect.
