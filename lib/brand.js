...
// THE CHROME VALUES ARE CSS VARIABLES, NOT HEX.
//
// Most of this app styles through inline style objects, so a hardcoded #000000 here meant
// every one of those call sites was pinned to the dark theme. Pointing them at the same
// custom properties the stylesheet uses means the whole app follows data-theme without any
// component knowing a theme exists.
//
// accent and accentDeep stay as literal hex on purpose. They are concatenated with alpha
// suffixes in several places, as in accent + "0F", and "var(--x)0F" is not a colour.
export const BRAND = {
  bg: "var(--brand-bg)",
