...
const HYROX_STATIONS = [
  { name: "SkiErg 500m", target: "500m", note: "Log your time, this is what you chase from here." },
  { name: "Row 500m", target: "500m", note: "Strong legs first, then body, then arms." },
  { name: "Battle Ropes", target: "6 x 30 sec on / 30 sec off", note: "Stay low, keep the waves even." },
  { name: "Sled Push & Pull", target: "20m push + 20m pull", note: "Low body angle, drive through the legs." },
  { name: "Weighted Lunge Walk", target: "100m", note: "Torso upright, controlled stride." },
];
...
export const GOAL_ORDER = [
  ...
  "loseweight", "cut", "bulk", "glutes", "strength", "calisthenics", "general",
];
...
export function buildWeek(goalIds, sessionsPerWeek) {
  ...
  return picked.map(function (day, i) {
    return Object.assign({}, day, { dayLabel: DAY_LABELS[slots[i]] });
  });
}
