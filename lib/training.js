...
const HYROX_STATIONS = [
  ...
  { name: "Battle Ropes", target: "10 x 30 sec on / 30 sec off", note: "Stay low, keep the waves even.", log: "rounds", rounds: 10 },
  { name: "Sled Push & Pull", target: "5 rounds: 20m push, 20m pull", note: "Low body angle, drive through the legs.", log: "rounds", rounds: 5 },
