...
// Monday of the week a date falls in. Local time, matching startOfThisWeek() on the plan
// page and date_trunc('week', ...) in Postgres, which is what get_leaderboard now uses.
...
// dashboard, the streak maths and the leaderboard all run Monday to Sunday.
//
